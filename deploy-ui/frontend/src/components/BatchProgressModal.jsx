...
const BatchProgressModal = ({ isOpen, onClose, completedBuilds, totalBuilds, currentProgress, currentMessage, currentBuildProgress, isComplete, successBuilds, failedBuilds }) => {
        ...
        <div className="p-6">
          ...
          {!isComplete && (
            <>
              ...
              {currentBuildProgress !== undefined && currentBuildProgress > 0 && (
                <div className="mb-4">
                  <div className="flex justify-between text-xs text-gray-600 mb-1">
                    <span>当前构建进度</span>
                    <span>{Math.round(currentBuildProgress)}%</span>
                  </div>
                      ...
                      {successBuilds.map((build, index) => (
                        <div key={index} className="bg-gray-50 rounded-lg p-3 mb-2">
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-gray-800">{build.apkName}</span>
                            <a
